...
from robertagen.prepare_dataset import DecoderTokenizer, get_dataset, get_train_dataloader, get_eval_dataloader
from robertagen.model import RoBERTaGen
...
def main(args_dict):
    ...
    logger.info(f"Decoder vocab size: {len(dec_tokenizer.w2id)}\n\t{dec_tokenizer.w2id.keys()}")
    
    """Build model"""
    model_args = RoBERTaGen.parse_model_args(args_dict)
